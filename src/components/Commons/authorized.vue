<template>
	<div id="authorized">
		<div class="header">
			...
			<span style="margin:0 auto;line-height:40px;">推荐用户</span>
		</div>
		<div class="content">
			<ul>
...
<script>
	export default{
		...
		created(){
			var _this=this;
			this.$http.get(window.apiAddress+"/api/authorized").then(function(response){
				_this.dataList=response.data.authorized_user;
			})
		}
	}
</script>
